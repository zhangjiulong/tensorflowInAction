...
class BucketSentenceIter(mx.io.DataIter):
    def __init__(self, path, vocab, buckets, batch_size,
        ...
        if len(buckets) == 0:
            buckets = default_gen_buckets(sentences, batch_size, vocab) #buckets save train items that num > batch size
        ...
        # assign sentences to data structure
        for sentence in sentences:
